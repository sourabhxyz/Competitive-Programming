...
// siz[v] denotes sum of all elements x[i] (or a[i]) in the subtree rooted at v
// sum[v] denotes answer only for subtree
// pre[v] deontes answer only for part excluding subtree
// clearly for each vertex answer is pre[v] + sum[v].
