...
bitset<18409210> bs; // 10^7 + small extra bits should be enough for most prime-related problems
...
int main() 
{
	sieve(18409201); // concept
	//freopen("in.txt","r",stdin);
    //freopen("out.txt","w",stdout);
    ll num,i,cnt=0;
	for(i=2;i<18409200;i++)//if I would have had sieve(10000000) then this would give time limit error.
	{
