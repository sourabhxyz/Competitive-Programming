...
vector<ll> factors; // vi "primes" (generated by sieve) is optional
ll PF_idx = 0, PF = prime[PF_idx]; // using PF = 2, 3, 4, ..., is also ok.
...
vector<ll>::iterator new_end = unique(factors.begin(), factors.end()); // get unique
int result = N;
